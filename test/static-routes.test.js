...
const ANDROID_DOWNLOAD_URL = 'https://github.com/gamleetee/gamleetee-Tunnel-Chat/releases/download/mobile-v0.2.0/gamleetee-chat.apk';
...
test('purple navigation shell and static application routes are available', { timeout: 15_000 }, async (context) => {
  ...
  assert.match(appsHtml, /Версия 0\.2\.0/);
